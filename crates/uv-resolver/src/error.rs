...
pub enum ResolveError {
    ...
    #[error("Requirements contain conflicting URLs for package `{package_name}` in {env}:\n- {}", urls.join("\n- "))]
    ConflictingUrls {
    ...
    #[error("Requirements contain conflicting indexes for package `{package_name}` in {env}:\n- {}", indexes.join("\n- "))]
